        ...
        <div className="container-narrow">
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed mb-4">
              Welcome to Amconz Infra Services. These Terms of Use ("Terms") govern your access to 
              and use of our website, services, and any related applications (collectively, the "Services").
            </p>
            <p className="text-muted leading-relaxed mb-4">
          ...
          <div className="mb-12">
            ...
            <ul className="space-y-3 text-muted">
              ...
              <li>
                <strong>"Services"</strong> refers to all services, products, and content provided by the Company.
              </li>
              <li>
                <strong>"User"</strong> or <strong>"You"</strong> refers to the individual or entity accessing our Services.
              </li>
              <li>
                <strong>"Website"</strong> refers to amconzinfra.com and all related subdomains.
              </li>
              <li>
                <strong>"Content"</strong> refers to all text, images, videos, and other materials on our Services.
              </li>
            </ul>
          </div>
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed mb-6">
              When creating an account with us, you must provide accurate, complete, and current information. 
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed mb-6">
              We provide facility management, engineering, and related infrastructure services. 
              Specific services are detailed in our service agreements and quotations.
            </p>

            <h3 className="text-xl font-semibold mb-4">Pricing and Payment</h3>
            <p className="text-muted leading-relaxed mb-6">
              All prices are quoted in Indian Rupees (INR) unless otherwise stated. Payment terms 
              will be specified in individual service agreements. We reserve the right to modify 
            ...
            <p className="text-muted leading-relaxed">
              ...
              Quotations are subject to site verification and may be revised based on actual conditions.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed mb-6">
              All content on our Services, including text, graphics, logos, images, software, and other 
              materials, is the property of Amconz Infra Services or its content suppliers and is protected 
            ...
            <p className="text-muted leading-relaxed mb-4">
              ...
              Services for personal or business purposes. You may not:
            </p>
            ...
            <p className="text-muted leading-relaxed">
              By submitting content to our Services (reviews, feedback, etc.), you grant us a worldwide, 
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed mb-6">
              To the maximum extent permitted by law, Amconz Infra Services shall not be liable for 
            ...
            <p className="text-muted leading-relaxed">
              You agree to indemnify and hold harmless Amconz Infra Services and its affiliates from 
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed">
              Your continued use of our Services after changes to these Terms constitutes acceptance 
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed">
              Your use of third-party services is at your own risk and subject to their respective 
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed">
              ...
              published on our Services, constitute the entire agreement between you and Amconz Infra 
              Services regarding the use of our Services.
            </p>
          </div>
