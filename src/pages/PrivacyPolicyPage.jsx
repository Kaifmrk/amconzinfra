        ...
        <div className="container-narrow">
          ...
          <div className="mb-12">
            <p className="text-muted leading-relaxed text-base mb-4">
              Amconz Infra Services ("we," "our," or "us") is committed to protecting your privacy. 
          ...
          <div className="mb-12">
            ...
            <p className="text-muted leading-relaxed mb-6">
              ...
              on our behalf, such as payment processing, email delivery, hosting services, and analytics.
            </p>
