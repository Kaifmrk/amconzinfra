    ...
    <div className="container-wide relative z-10">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div className="max-w-3xl">
          <div className="mb-6"><Eyebrow>What We Deliver</Eyebrow></div>
          ...
          <p className="text-lg leading-relaxed max-w-xl text-[#5A6A7A] dark:text-[#8B9BB0]" style={{ fontWeight: 300 }}>
            Every service delivered by certified professionals — with a single point of accountability.
          </p>
        </div>
        ...
        <div className="relative hidden lg:block">
          <div className="relative w-full h-[420px]">
              ...
              <div className="relative">
                ...
                <div className="w-36 h-36 rounded-full flex items-center justify-center" 
                  ...
                  <div className="text-center">
                    <p className="text-4xl font-bold mb-1" style={{ color: "#C8963E", fontFamily: "'Playfair Display', serif" }}>13</p>
                    <p className="text-[9px] uppercase tracking-wider text-white/70" style={{ fontFamily: "'DM Mono', monospace" }}>Services</p>
                  </div>
                </div>
                
                {/* Rotating ring */}
                <div className="absolute inset-0 w-36 h-36 rounded-full border-2 border-dashed" 
                     style={{ borderColor: "#C8963E40", animation: "spin 20s linear infinite" }} />
              </div>
            </div>

            {/* Service Category Icons - Orbiting */}
            {[
              { icon: "Zap", label: "Electrical", angle: 0, color: "#3B82F6", radius: 130 },
              { icon: "Paintbrush", label: "Interior work's", angle: 144, color: "#8B5CF6", radius: 130 },
              { icon: "Building2", label: "Construction", angle: 72, color: "#F97316", radius: 130 },
              { icon: "Shield", label: "Security", angle: 216, color: "#EC4899", radius: 130 },
              { icon: "Wrench", label: "Maintenance", angle: 288, color: "#C8963E", radius: 130 },
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[8px] font-bold text-[#19184C]">{item.label}</span>
                  </div>
                </div>
              );
            })}
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ opacity: 0.2 }}>
              <defs>
                <radialGradient id="lineGrad">
                  <stop offset="0%" style={{ stopColor: "#C8963E", stopOpacity: 0 }} />
                  <stop offset="50%" style={{ stopColor: "#C8963E", stopOpacity: 1 }} />
                  <stop offset="100%" style={{ stopColor: "#C8963E", stopOpacity: 0 }} />
                </radialGradient>
              </defs>
            ...
            {/* Stat Cards */}
            <div className="absolute top-4 right-4 px-4 py-2.5 rounded-lg backdrop-blur-sm" 
                 style={{ background: "rgba(255,255,255,0.9)", border: "1px solid rgba(200,150,62,0.25)" }}>
            ...
            <div className="absolute bottom-4 left-4 px-4 py-2.5 rounded-lg backdrop-blur-sm" 
                 style={{ background: "rgba(255,255,255,0.9)", border: "1px solid rgba(200,150,62,0.25)" }}>
              <div className="flex items-center gap-2">
                <Icon name="Award" size={14} style={{ color: "#C8963E" }} />
                <div>
                  <p className="text-xs font-bold text-[#19184C]">Single Point</p>
            ...
            {/* Decorative Dots */}
            <div className="absolute top-16 left-8 w-2 h-2 rounded-full" style={{ background: "#C8963E40", animation: "pulse 2s ease-in-out infinite" }} />
            <div className="absolute bottom-20 right-12 w-2 h-2 rounded-full" style={{ background: "#3B82F640", animation: "pulse 2s ease-in-out infinite 0.5s" }} />
            <div className="absolute top-24 right-16 w-2 h-2 rounded-full" style={{ background: "#8B5CF640", animation: "pulse 2s ease-in-out infinite 1s" }} />
          </div>
        </div>
      </div>
    </div>
    ...
    <section className="section bg-[#F8F7F4] pt-0 dark:bg-[#1E1D54]">
      <div className="container-tight text-center">
        ...
        <p className="text-muted mb-10 max-w-lg mx-auto leading-relaxed">
          Our team will assess your facility requirements and propose a tailored service package.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <Btn variant="primary" icon="ArrowRight" onClick={() => go("/enquiry")}>
            Request a Proposal
          </Btn>
